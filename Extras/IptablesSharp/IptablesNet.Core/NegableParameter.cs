...
namespace IptablesNet.Core
{
	...
	/// </summary>
	/// <remarks>
	/// This is the base class for other objects that models parameters in the rules of
	/// iptables.
	/// </remarks>
	public abstract class NegableParameter: AbstractParameter
	{
	    ...
	    /// <summary>
	    /// Gets/sets if the meaning of the value should be complemented or interpreted
	    /// inverselly.
	    /// </summary>
	    public bool Not
	    {
