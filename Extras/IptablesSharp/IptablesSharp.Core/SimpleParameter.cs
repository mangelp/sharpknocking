...
namespace IptablesNet.Core
{
    ...
    /// <summary>
    /// Models a generic parameter with common properties.
    /// </summary>
    /// <remarks>
    ...
    /// This class is mainly used in the first stage of parsing the imput string (that it
    /// has to be in the same format as iptables-save output) to get an array of objects
    /// that is more easy to convert to the concrete objects.
    /// </remarks>
	public class SimpleParameter: NegableParameter
	{
		//FIXME: Erase this commented block if it not necesary
//		/// <summary>
//		/// Gets if the parameter has long format
//		/// </summary>
//		/// <remarks>
//		/// If the name of the parameter is not null and has more than one character it 
//		/// is considered to have long format.
//		/// </remarks>
