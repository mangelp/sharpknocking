...
namespace IptablesNet.Core.Extensions.ExtendedMatch
{
    ...
    /// <br/><br/>
	/// </remarks>
	public abstract class MatchExtensionHandler: IExtensionHandler
	{
	    // ------------------------------------------------------------- //
	    ...
	    /// </remakrs>
	    protected List<SimpleParameter> InternalList
	    {
...
//	        }
        ...
        /// </remarks>
	    protected void AddParameterWithoutChecks(SimpleParameter param)
	    {
			//FIXME: BROKEN
