...
namespace Developer.Common.Unix.SystemCommands
{
	...
	public class UnixTextInputSysCmd: BaseUnixSysCmd
	{
		/// <summary>
		...
		/// </param>
		public UnixTextInputSysCmd(string cmd)
			:base(cmd)
		{
		}
		...
		/// </param>
		public UnixTextInputSysCmd(string cmd, bool requireRoot)
