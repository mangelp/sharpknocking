...
namespace SharpKnocking.Doorman
{
	public class TrayIcon
	{
		...
		private void InitializeWidgets()
		{
			...
			eb.Add(new Gtk.Image(ImageResources.SharpKnockingIcon22));
			// hooking event
			eb.ButtonPressEvent += new ButtonPressEventHandler (this.OnImageClick);
			TrayHelper icon = new TrayHelper("Doorman");
			icon.Add(eb);
		...
		private void OnQuitItemActivated(object o, EventArgs args)
		{
			window.Quit();
		}
		...
		/// <summary>
		/// This class helps creating the system tray icon.
		/// It uses code from http://www.mono-project.com/GtkSharpNotificationIcon.
		/// </summary>
		class TrayHelper : Plug
		{
			int stamp;
		...
		#endregion Imported Enums & structs
